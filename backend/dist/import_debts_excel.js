        ...
        for (const set of sets) {
            if (set.amount !== undefined && set.amount !== null && set.amount !== '') {
                ...
                if (isNaN(amountNum) || amountNum <= 0)
                    continue;
                const totalDec = new decimal_js_1.Decimal(amountNum);
                ...
                let totalMatched = new decimal_js_1.Decimal(0);
                for (const matched of matchedItems) {
                    const matchedPrice = new decimal_js_1.Decimal(matched.product.precio_venta);
                    ...
                    await prisma.detalleCuenta.create({
                        data: {
                            ...
                            cantidad: new decimal_js_1.Decimal(matched.quantity),
                ...
                if (difference.abs().gt(0.01)) {
                    ...
                    await prisma.detalleCuenta.create({
                        data: {
                            ...
                            cantidad: new decimal_js_1.Decimal(1),
