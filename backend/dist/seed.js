...
async function main() {
    ...
    await db_1.default.usuarioRole.deleteMany({});
    await db_1.default.inventarioArea.deleteMany({});
    await db_1.default.recetaIngrediente.deleteMany({});
    ...
    await db_1.default.producto.deleteMany({});
    await db_1.default.insumo.deleteMany({});
    await db_1.default.cliente.deleteMany({});
    await db_1.default.cadi.deleteMany({});
    await db_1.default.area.deleteMany({});
    await db_1.default.role.deleteMany({});
    await db_1.default.usuario.deleteMany({});
    console.log('Limpieza completada');
    // 1. Roles
    console.log('Insertando roles...');
    await db_1.default.role.createMany({
        data: [
            {
                "id": 1,
                "nombre": "ADMIN",
    ...
    await db_1.default.usuario.createMany({
        data: [
            {
                "id": 1,
                "username": "admin",
    ...
    await db_1.default.usuarioRole.createMany({
        data: [
            {
                "usuario_id": 1,
                "role_id": 1
    ...
    await db_1.default.cliente.createMany({
        data: [
            {
                "id": 50,
    ...
    await db_1.default.cadi.createMany({
        data: [
            {
                "id": 5,
                "numero_cadi": "CADI-1",
    ...
    await db_1.default.producto.createMany({
        data: [
            {
                "id": 396,
    ...
    await db_1.default.inventarioArea.createMany({
        data: [
            {
                "area_id": 3,
                "producto_id": 397,
    ...
    await db_1.default.insumo.createMany({
        data: []
    });
    // 10. Recetas
    console.log('Insertando recetas...');
    await db_1.default.recetaIngrediente.createMany({
        data: []
    });
